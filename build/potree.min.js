...
THREE.NoBlending,this.transparent=!1,this.depthWrite=this.depthTest=!0,this.depthFunc=THREE.LessEqualDepth):1>this.opacity&&!this.useEDL&&(this.blending=THREE.NormalBlending,this.depthWrite=this.depthTest=this.transparent=!0,this.depthFunc=THREE.LessEqualDepth);this.weighted&&(this.blending=THREE.AdditiveBlending,this.depthTest=this.transparent=!0,this.depthWrite=!1);this.needsUpdate=!0};F.prototype.onBeforeCompile=function(c,a){a.capabilities.logarithmicDepthBuffer&&(c.fragmentShader='#define USE_LOGDEPTHBUF\n#define USE_LOGDEPTHBUF_EXT\n#define EPSILON 1e-6\n'+
